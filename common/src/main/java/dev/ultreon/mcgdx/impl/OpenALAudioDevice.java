...
public class OpenALAudioDevice implements AudioDevice {
	...
	private final OpenALMinecraftAudio audio;
	...
	public OpenALAudioDevice (OpenALMinecraftAudio audio, int sampleRate, boolean isMono, int bufferSize, int bufferCount) {
		this.audio = audio;
		channels = isMono ? 1 : 2;
