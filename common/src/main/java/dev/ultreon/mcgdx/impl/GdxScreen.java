...
public class GdxScreen extends Screen {
    ...
    public final void render(GuiGraphics guiGraphics, int i, int j, float f) {
        if (!this.gdx.isOnGdxThread()) {
            ...
            guiGraphics.drawCenteredString(super.font, "§lRender Failure", width / 2, height / 2, 0xffffffff);
            guiGraphics.drawCenteredString(super.font, "§oInvalid Thread", width / 2, (int) (height / 2 + super.font.lineHeight + 1), 0xffffffff);
            return;
        }
