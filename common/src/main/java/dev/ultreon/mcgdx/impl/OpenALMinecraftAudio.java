...
import com.badlogic.gdx.backends.lwjgl3.audio.*;
...
/** @author Nathan Sweet */
public class OpenALMinecraftAudio implements MinecraftAudio {
	...
	public OpenALMinecraftAudio () {
		this(16, 9, 512);
	}

	public OpenALMinecraftAudio (int simultaneousSources, int deviceBufferCount, int deviceBufferSize) {
	...
	public OpenALSound newSound (FileHandle file) {
		...
		try {
			return soundClass.getConstructor(new Class[] {OpenALMinecraftAudio.class, FileHandle.class}).newInstance(this, file);
		} catch (Exception ex) {
	...
	public OpenALMusic newMusic (FileHandle file) {
		...
		try {
			return musicClass.getConstructor(new Class[] {OpenALMinecraftAudio.class, FileHandle.class}).newInstance(this, file);
		} catch (Exception ex) {
