...
public class MinecraftInput extends AbstractInput {
	...
	public final GLFWKeyCallbackI keyCallback = this::keyCallback;
	...
	public GLFWCharCallbackI charCallback = new GLFWCharCallbackI() {
			...
			MinecraftInput.this.window.getGraphics().requestRendering();
			eventQueue.keyTyped((char)codepoint, System.nanoTime());
		}
	};

	public final GLFWScrollCallbackI scrollCallback = (window, scrollX, scrollY) -> {
        MinecraftInput.this.window.getGraphics().requestRendering();
        eventQueue.scrolled(-(float)scrollX, -(float)scrollY, System.nanoTime());
    };

	public final GLFWCursorPosCallbackI cursorPosCallback = new GLFWCursorPosCallbackI() {
	...
	public MinecraftInput(MinecraftWindow window) {
		this.window = window;
