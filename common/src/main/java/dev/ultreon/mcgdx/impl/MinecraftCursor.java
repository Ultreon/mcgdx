...
public class MinecraftCursor implements Cursor {
	static final Array<MinecraftCursor> cursors = new Array<MinecraftCursor>();
	...
	MinecraftCursor (MinecraftWindow window, Pixmap pixmap, int xHotspot, int yHotspot) {
		this.window = window;
	...
	static void dispose (MinecraftWindow window) {
		for (int i = cursors.size - 1; i >= 0; i--) {
			MinecraftCursor cursor = cursors.get(i);
